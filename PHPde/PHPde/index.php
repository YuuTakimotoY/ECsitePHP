...
if ( $link !== false ) {
 ...
 //画面左側の「ログイン」ボタンが押された時
    if( $_REQUEST["cmd"] == "do_login" )
    {
        ...
        $query = "SELECT * FROM m_customers WHERE customer_code like '".$_REQUEST["login_id"]."' AND pass like '".$_REQUEST["login_pass"]."'";
...
$data = array();
    ...
    foreach( $data as $key => $val ){
                                ...
                                <dl class="products">
                                    <dt>
                                        <a href="itemdetail.php?code=<?php print( htmlspecialchars( $val["item_code"] ) ); ?>">
                                            <img src="img/thumb/<?php print( htmlspecialchars( $val["image"], ENT_QUOTES ) ); ?>" alt="" />
                                            <br />
                                            <?php print( $val["item_name"]); ?>
                                        </a>
                                    </dt>
                                    <dd>
                                        &yen;<?php print( htmlspecialchars( $val["price"], ENT_QUOTES ) ); ?>
                                    </dd>
                                </dl>
