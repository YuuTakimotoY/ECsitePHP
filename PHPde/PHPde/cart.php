    ...
    if( isset ( $_SESSION["cart"] ) )
    {
        foreach( $_SESSION["cart"] as $cart )
        {
                                    ...
                                    <tr>
                                        ...
                                        <td class="tc2">
                                            <?php print( $cart["item_name"] ); ?>(<?php print( $cart["num"] ); ?>個)
                                        </td>
                                        <td class="tc3">
                                            &yen;<?php print( $cart["price"] ); ?>
                                        </td>
                                        <td class="tc4">
                                            <a href="itemdetail.php?code=<?php print( $cart["item_code"] ); ?>">詳細</a>
                                        </td>
                                        <td class="tc5">
                                            <a href="cart.php?cmd=del&code=<?php print( $cart["item_code"] ); ?>">削除</a>
                                        </td>
                                    </tr>
                                    <?php
        }
